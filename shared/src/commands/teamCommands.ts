...
export const TeamCommands = {
  ...
  AssignTeamMember: defineCommand('cmd/team/assignMember', (activityId: string, participantId: string, target?: AssignmentTarget) => ({ payload: { activityId, participantId, target } }), TeamEvents.TeamMemberAssigned),
  AssignEquipment: defineCommand('cmd/team/assignEquipment', (activityId: string, item: EquipmentItem, target?: AssignmentTarget) => ({ payload: { activityId, item, target } }), TeamEvents.TeamEquipmentAssigned),
};
