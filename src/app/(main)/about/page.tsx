...
function AboutOverview() {
  return (
    <>
      ...
      <Typography>
        <p>The Respond app is a mission management tool used to communicate mission information and enable responders to sign in to missions so that mission leadership knows how many responders are enroute.</p>
      </Typography>
    </>
  );
}
...
function AboutHomePage() {
  return (
    <>
      ...
      <Typography>
        <p>The Home page provides an overview of recent, ongoing, and future activities.</p>
      </Typography>

      <Typography variant="h6">My Activity</Typography>
      <Typography>
        <p>The &quot;My Activity&quot; section contains an abbreviated list of the activities that you are currently involved with. It will only be present if are currently signed into, or on standby for, an activity.</p>
      </Typography>

      <Typography variant="h6">Missions</Typography>
      <Typography>
        <p>The &quot;Missions&quot; section will contain a list of missions that are currently active, or which concluded within the last 3 days. At present there is no option to view missions that are older than 3 days.</p>
      </Typography>

      <Typography variant="h6">Events</Typography>
      <Typography>
        <p>The &quot;Events&quot; section contains a list of Trainings or other Events that are currently active, or which concluded within the last 3 days. At present there is no option to view Events that are older than 3 days.</p>
      </Typography>
    </>
  );
}
...
function AboutResponding() {
  return (
    <>
      ...
      <Typography>
        <p>The primary functionality of Respond is to enable members to sign in and report they are responding to a Mission, Training or other Event. It also provides a way for mission leadership to keep track of the status of responders and see their relevant qualifications. In the future, the timeline events will be used to automate roster entry into the database.</p>
      </Typography>

      <Typography variant="h6">Signing Into an Activity</Typography>
      <Typography>
        <p>By default, the button in each Mission or Event will indicate the expected next action, based on your current status. For example, if you have not signed in yet, or if you are on standby, it will say “Sign In”. Clicking Sign In will sign you into the Mission. Once you are signed in, the button will switch to Sign Out. Clicking it again will sign you out of the mission. Some statuses have a secondary option which appear in a dropdown menu.</p>
      </Typography>

      <Typography variant="h6">Standby for a Future Activity</Typography>
      <Typography>
        <p>Respond is introducing a new feature that enables you to indicate that you are available for a current or future mission, but are not currently responding. Missions that are scheduled to start in the future will default to Stand By; you will not be able to sign into a mission that has not started. To cancel, you can choose Sign Out from the dropdown menu.</p>
      </Typography>
    </>
  );
}
...
function AboutActivityPage() {
  return (
    <>
      ...
      <Typography>
        <p>Clicking the Edit Button will open a form that allows you to edit the mission details.</p>
      </Typography>
      ...
      <Typography>
        <p>Clicking the Red delete icon will delete the mission, which removes it from the Home Page.</p>
      </Typography>
    </>
  );
}
